...
class InstallerLang{
	...
	public function __construct($lang = ""){
		if(file_exists(\pocketmine\PATH . "src/pocketmine/lang/base/" . $lang . ".ini")){
			...
			$files = [];
			foreach(new \DirectoryIterator(\pocketmine\PATH . "src/pocketmine/lang/base/") as $file){
			...
			if(count($files) > 0){
				...
				$this->langfile = \pocketmine\PATH . "src/pocketmine/lang/base/" . $l . ".ini";
			}else{
				$this->lang = "en";
				$this->langfile = \pocketmine\PATH . "src/pocketmine/lang/base/eng.ini";
			}
		}

		$this->loadLang(\pocketmine\PATH . "src/pocketmine/lang/base/eng.ini", "eng");
		if($this->lang !== "en"){
